...
Console.WriteLine("Thanks to the CUE4Parse team (https://github.com/FabianFG/CUE4Parse) and Crauzer (https://github.com/Crauzer/WEMSharp) for their libraries.");
  ...
  if(Directory.Exists(args[0]) && (File.Exists(Path.Combine(args[0], "KidAMnesia.exe")) || skipFileIntegrityChecks)) {
    ...
    if (key.StartsWith("0x") && key.Length == 66) {
      ...
      if(Directory.Exists(basePath)) {
        ...
        Console.Write("This operation will use approximately 2.6GB of disk space. Are you sure you want to continue? (Y/n) ");
